...
\\
L'utilizzo di component associati alle entità, permette di semplificare e suddividere quest'ultime permettendo di aggevolarne 
...
\begin{itemize}
    ...
    \item \textbf{Controller:} A ricoprire questo ruolo troviamo l'interfaccia \emph{GameState}.
\end{itemize}
